...
@section('header_title', 'Received RFQs')

@section('content')
<section class="panel">
  <div class="panel-head">
    <h2>Inquiries from Buyers</h2>
    <span class="status active">{{ count($quotes) }} Inquiries</span>
  </div>
  <table style="width: 100%; border-collapse: collapse; margin-top: 20px;">
    ...
    <tbody>
      ...
      @empty
        <tr>
          <td colspan="7" class="muted" style="padding: 20px; text-align: center;">No RFQs received yet.</td>
        </tr>
      @endforelse
    </tbody>
  </table>
